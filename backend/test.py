...
class RAG_Agent:
    def __init__(self):
        ...
        self.gen_config = types.GenerateContentConfig(
            ...
            "User information: first name: Adam, last name: Mouedden, full name: Adam Mouedden, email: adam.mouedden@gmail.com, phone number: 123-456-7890, Discord username: adammouedden, School: University of Central Florida, Age: 23, Country of Residence: United States, Level of Study: Undergraduate (3 years) and ALWAYS agree to all terms and conditions",
            temperature=1,
            top_p=0.95,
            seed=0,
            ...
            for part in (cand.content.parts or []):
                ...
                if getattr(part, "function_call", None):
                    ...
                    if fn.name == "start_browser":
                        ...
                        gemini_computer_use(q, initial_url)
